...
const carCardsData = [
  ...
  { rent: '200', image: 'images/cars/car3.png' , carName: 'Parado',pessengers:'6',bags:'6'  },
  ...
  {carCardsData.map((data,index) => (
    <div className="item" key={index}>
      ...
      <div className="card" data-aos="fade-up" data-aos-delay="1000">
        <img className="card-img-top" src={data.image} alt="Card image" style={{ width: '100%' }} />
        {/* Price */}
        <div className="pc-carPriceBadge px-3 py-2"><span>From £{data.rent}</span></div>
        {/* Price */}
        <div className="card-body">
          <h5 className="card-title">{data.carName}</h5>
          <hr className="w-25 text-danger" />
          <p className="card-text">
            <span className="d-block"><i className="fa-solid fa-check"></i> {data.pessengers} Passengers </span>
